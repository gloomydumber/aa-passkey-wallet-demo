 ...
 */
export function createBundlerClientForNetwork<
  TSmartAccount extends SmartAccount | undefined = undefined,
>(config: BundlerClientConfig, account?: TSmartAccount, options?: BundlerClientOptions) {
  ...
  const pimlicoClient =
    sponsored && network.paymasterUrl
      ? createPimlicoClient({
