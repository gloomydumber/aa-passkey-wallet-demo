 ...
 *
 * TODO: Implement transfer UI with UserOperation building.
 */
    ...
    <div className="mx-auto max-w-lg p-4">
      ...
      <Card>
        ...
        <CardContent className="text-center text-sm text-zinc-500 dark:text-zinc-400">
          The send functionality will be implemented in a future update.
          This will include UserOperation building and transaction submission.
        </CardContent>
      </Card>
    </div>
  );
